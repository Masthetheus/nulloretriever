...
if __name__ == "__main__":
    df = pd.read_csv("workflow/shuffled_results/nullomer_statistics_summarized.csv", sep=',')
    ...
    print(df_new)
    df_new.to_csv("workflow/shuffled_results/filtered_nullomer_statistics_summarized.csv", sep=',')
